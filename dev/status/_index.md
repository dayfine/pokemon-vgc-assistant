...
| vision      | dev/status/vision.md       | feat-vision      | M5.0 merged; M5.7 (builder-screen vision) deferred. See `dev/plans/05-vision-design.md` |
| cli         | dev/status/cli.md          | feat-cli         | M6.0 — CLI scaffold (NOT_STARTED). See `dev/plans/07-cli-design.md` |
